...
export const projects = [
  {
    ...
    name: "iHatePDF",
    description:
      "Herramientas PDF en el navegador, rápidas y directas para editar documentos sin vueltas.",
    ...
    images: [
      {
        ...
        alt: "iHatePDF — landing y búsqueda de herramientas"
      },
      {
    ...
    images: [
      {
        ...
        alt: "HateWebcam — vista webcam con detección de caras"
      },
      {
