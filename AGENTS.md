...
- `npm run gallery:sync` — Sharp thumbs + regenerate `src/data/galleryManifest.ts`
...
- **Page chrome** (header, Escape, Lenis, motion enter) → `PortfolioPageShell`.
...
- Gallery originals: `public/galeria/originales/` then `npm run gallery:sync`.
