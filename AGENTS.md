...
- Generated: `public/galeria/view/` (~1200px WebP lightbox), `public/galeria/thumbs/` (~420px WebP), `src/data/galleryManifest.ts`. Legacy `masters/` is pruned on sync when unlocked.
